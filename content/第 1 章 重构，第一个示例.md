...
这是一个简单的例子，但我希望它能让你对“重构怎么做”有一点感觉。例中我已经示范了数种重构手法，包括[[第 6 章 第一组重构/6.1 Extract Function|提炼函数]]（106）、[[第 6 章 第一组重构/6.4 Inline Variable|内联变量]]（123）、[[第 8 章 搬移特性/8.1 Move Function|搬移函数]]（198）和以多态取代条件表达式（272）等。
